      ...
      <Container>
        <div className="flex flex-col md:flex-row justify-between pt-16 pb-8">
          ...
          <FooterList>
            ...
            <Link href="#">Returnse & Exchanges</Link>
            <Link href="#">Watches</Link>
            <Link href="#">FAQs</Link>
          </FooterList>
          <div className="w-full md:w-1/3 mb-6 md:mb-0">
            <h3 className=" font-bold mb-2 text-base">About Us</h3>
            <p className="mb-2">
              At our electronics store ,we are dedicated to providing the latest
              and greatest devices and accessories to our customers with wide
              selection of phones TVS,laptops,watches and accessories.
            </p>
            <p>
              {" "}
              &copy;{new Date().getFullYear()} E-Shop. All right reserved by
              Ahmed Hussien{" "}
            </p>
          </div>
          <FooterList>
            <h3 className="font-bold mb-2 text-base"> Follow Us </h3>
