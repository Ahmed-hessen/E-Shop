...
export default function ProductDetails({ product }: ProductDetailsProps) {
  ...
  //To check if the product in cart or not
  useEffect(() => {
  ...
  //Calculate the rating by using average
  const AverageProductRating =
    product.reviews.reduce((acc: number, item: any) => item.rating + acc, 0) /
    product.reviews.length;

  //Change the color of images when click on the colors
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
      ...
      <div className="flex flex-col gap-1 text-slate-500 text-sm">
        ...
        <p className="font-semibold text-black text-medium md:text-lg">
